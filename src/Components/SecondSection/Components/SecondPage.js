        ...
        <div className="py-0 ">
            ...
            <div className='w-full flex justify-center' data-aos="fade-up">
                <div className=' py-6 max-w-[925px]'>
                    ...
                    <div className={`${GreatVibes.className} tracking-[0.05em] text-[28px] md:text-[1.5rem] lg:text-[2rem] xl:text-[2.5rem] font-semibold text-center py-3`} data-aos="flip-left" data-aos-easing="ease-in">
                        Date : 11 May 2025
                    </div>
                    <hr className='border-[#b3b1b1]' />
                    <div style={{ fontFamily: 'var(--font-main-global)' }} className={`tracking-[0.08em] text-[20px] md:text-[1.5rem] lg:text-[2rem] font-semibold text-center py-3`} data-aos="flip-up" data-aos-easing="ease-in">
                        ...
                        Bilinaka, near Sagar Darshan Apartment,Asthmangal Apartment, Bilimora.
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2'>
                <div className='flex  flex-row justify-center items-center py-4' data-aos="flip-up">
                    <div className='flex justify-center items-center' data-aos="fade-up-right">
                        <img src="/ganesha.png" className='h-[150px] md:h-[120px]' alt="wedding" />
                    </div>
                    <div className={`${AnekGujrati.className} text-center text-[1.2rem] md:text-[1.3rem] xl:text-[1.5rem] p-4`}>
                        <div className='font-extrabold'>
                        तेलवण (Telvan)
                        </div>
                        <div className={`font-medium tracking-wider text-[1rem] sm:text-[1.1rem] xl:text-[1.3rem] `}>
                            Date: 11-2-2025
                        </div>
                ...
                <div className='flex  flex-row justify-center items-center py-4' data-aos="flip-up">
                    <div className='flex justify-center items-center' data-aos="fade-up-left">
                        <img src="/dandiyaRas.png" className=' h-[150px] md:h-[120px]' alt="wedding" />
                    </div>
                    <div className={`${AnekGujrati.className} text-center text-[1.2rem] md:text-[1.3rem] xl:text-[1.5rem] p-4`}>
                        <div className='font-extrabold'>
                            जागरण गोंधळ (Jagaran Gondhal)
                        </div>
                        <div className='font-medium text-[1rem] sm:text-[1.1rem] xl:text-[1.3rem]'>
                            Date: 11-5-2025
                        </div>
            ...
            <div className='flex  flex-row justify-center items-center py-4' data-aos="flip-up">
                ...
                <hr className='sm:hidden' /> */}
                <div className='flex justify-center items-center flex-row py-4  max-sm:col-span-1 max-lg:col-span-2' data-aos="flip-up">
                    <div className='flex justify-center items-center' data-aos="fade-up-left">
                        <img src="/twoKalsh.png" className='h-[150px] md:h-[120px]' alt="wedding" />
                    </div>
                    <div className={`${AnekGujrati.className} text-center text-[1.2rem] md:text-[1.3rem] xl:text-[1.5rem] p-4`}>
                        <div className='font-extrabold'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2'>
                ...
                <div className='flex max-sm:flex-row-reverse flex-row justify-center items-center py-4' data-aos="flip-up">
                    <div className='flex justify-center items-center' data-aos="fade-up-right">
                        <img src="/IndianDinner.png" className=' h-[150px] md:h-[120px]' alt="wedding" />
                    </div>
                    <div className={`${AnekGujrati.className} text-center text-[1.2rem] md:text-[1.3rem] xl:text-[1.5rem] p-4`}>
                        <div className='font-extrabold'>
                            भोजन समारंभ  
