                        ...
                        <div className="flex gap-2 sm:gap-5 justify-center items-center">
                            ...
                            <div className="countDownBg py-4 px-4 rounded-full relative">
                                <div className="w-full flex h-full flex-col items-center justify-center">
                                    ...
                                    <img
                                        src={countdown.days < 1 ? "/LatkanHeart.png" : "/LatkanHeart2.png"}
                                        className="absolute top-[3.5rem] z-[-1]"
                                        alt="wedding"
                                    />
                                </div>
                            ...
                            <div className="countDownBg py-4 px-6 rounded-full relative">
                                <div className="w-full flex h-full flex-col items-center justify-center">
                                    ...
                                    <img
                                        src={countdown.days < 1 ? "/LatkanHeart2.png" : "/LatkanHeart3.png"}
                                        className={`absolute ${countdown.days < 1 ? "top-[3rem]" : "top-[2rem]"} z-[-1]`}
                                        alt="wedding"
                                    />
                                </div>
                            </div>
                ...
                <div className="flex items-center justify-center ">
                    <div className="bg-white px-5 pt-5 lg:px-10 lg:pt-10 pb-4 gap-4 flex flex-col h-[90%] w-full">
                        <div className="h-[500px] relative max-w-full">
                            <div className={"pic bg-[url('/preImage/pre-wedding.jpg')]"} id={"pic5"} />
                            <div className={"pic bg-[url('/preImage/pre-wedding2.jpg')]"} id={"pic4"} />
                            <div className={"pic bg-[url('/preImage/pre-wedding3.jpg')]"} id={"pic3"} />
                            <div className={"pic bg-[url('/preImage/pre-wedding4.jpg')]"} id={"pic2"} />
                            {/* <div className={"pic bg-[url('/preImage/pre-wedding5.jpg')]"} id={"pic1"} /> */}
                        </div>
                        <hr />
